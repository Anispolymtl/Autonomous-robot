...
@Module({
    ...
    providers: [Logger, RosService, MissionService, MissionDatabaseService, SocketService, ClientGateway, MissionRuntimeService, BatteryService, CodeEditorService, NavService, StateService, MappingSerivce],
})
