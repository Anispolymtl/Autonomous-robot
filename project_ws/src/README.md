...
* `simulation_description` - holds the sdf description of the simulated system and any other assets.

* `simulation_gazebo` - holds gazebo specific code and configurations. Namely this is where systems end up.

* `simulation_application` - holds ros2 specific code and configurations.
